namespace AgileMultiIdeogramFileTester
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnSelect.Location = new System.Drawing.Point(348, 63);
            ...
            this.label1.Text = "Select the file type using the dropdown list below. Then press the \'Select\' butto" +
    "n to select the file. The results will be shown in the text area below.";
            // 
            // btnQuit
            // 
            ...
            this.Name = "Form1";
            this.Text = "Agile Multideogram file tester";
